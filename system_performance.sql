...
CREATE TABLE Machine(EmpID varchar(10),SystemName varchar(15) NOT NULL,UUID varchar(40) PRIMARY KEY,Config varchar(10) NOT NULL,MaxCpuUsage varchar(10),MaxUsedRAM varchar(10),FOREIGN KEY (EmpID) REFERENCES Employees(EmpID));
